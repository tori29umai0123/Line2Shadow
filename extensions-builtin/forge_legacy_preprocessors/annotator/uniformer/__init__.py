...
config_file = os.path.join(os.path.dirname(os.path.realpath(appropriate_file_path)),  "upernet_global_small.py")
old_modeldir = os.path.dirname(os.path.realpath(appropriate_file_path))
model = None
