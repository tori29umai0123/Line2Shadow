...
test_result_dir = Path(appropriate_file_path).parent / "results" / f"test_result_{timestamp}"
test_expectation_dir = Path(appropriate_file_path).parent / "expectations"
os.makedirs(test_expectation_dir, exist_ok=True)
resource_dir = Path(appropriate_file_path).parents[1] / "images"
