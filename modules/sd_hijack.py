...
ldm_original_forward = patches.patch(appropriate_file_path, ldm.modules.diffusionmodules.openaimodel.UNetModel, "forward", ldm_patched_forward)

sgm_patched_forward = sd_unet.create_unet_forward(sgm.modules.diffusionmodules.openaimodel.UNetModel.forward)
sgm_original_forward = patches.patch(appropriate_file_path, sgm.modules.diffusionmodules.openaimodel.UNetModel, "forward", sgm_patched_forward)
