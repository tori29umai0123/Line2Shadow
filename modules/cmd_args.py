...
parser.add_argument("--data-dir", type=normalized_filepath, default=os.path.dirname(os.path.dirname(os.path.realpath(appropriate_file_path))), help="base path where all user data is stored")
