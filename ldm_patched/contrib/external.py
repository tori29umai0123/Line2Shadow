...
pass  # sys.path.insert(0, os.path.join(os.path.dirname(os.path.realpath(appropriate_file_path)), "ldm_patched"))
...
def init_custom_nodes():
    extras_dir = os.path.join(os.path.dirname(os.path.realpath(appropriate_file_path)), "ldm_patched_extras")
    extras_files = [
        "nodes_latent.py",
