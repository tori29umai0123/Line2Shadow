...
def build_payload(prompt, nega, w, h, unit1,encoded_base, encoded_mask, ai_strength):
    return {
        "init_images": [encoded_base],
        "mask": encoded_mask,      
        "denoising_strength": ai_strength,
        "prompt": prompt,
...
def create_and_save_images(input_url, prompt, nega, canny_pil,mask_pil, base_pil, output_path, ai_strength):
    ...
    payload = build_payload(prompt, nega, w, h, unit1,encoded_base,encoded_mask, ai_strength)
